...
import br.com.santander.internetbanking.exception.ErrorResponseBalance;
...
public class ValidationErrorHandler {
    ...
    public ResponseEntity<ErrorResponseBalance> handleRuntimeException(RuntimeException ex) {
        ErrorResponseBalance errorResponse = new ErrorResponseBalance("Nao foi possivel fazer a operacao.");
